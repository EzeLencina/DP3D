...
export const CostsEditor: React.FC = () => {
    ...
    // Los costos se ingresan y se muestran en la moneda seleccionada, sin conversión automática
    ...
    return (
        <Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                <Input label="Costo Filamento" id="filamentCostPerKg" name="filamentCostPerKg" type="number" value={costs.filamentCostPerKg === 0 ? '' : costs.filamentCostPerKg} onChange={handleChange} icon="paid" unit={country.symbol} placeholder="0" />
                <Input label="Mano de Obra" id="laborCostPerHour" name="laborCostPerHour" type="number" value={costs.laborCostPerHour === 0 ? '' : costs.laborCostPerHour} onChange={handleChange} icon="engineering" unit={country.symbol} placeholder="0" />
                ...
                <Input label="Costo kW/h" id="electricityCostKwh" name="electricityCostKwh" type="number" value={costs.electricityCostKwh === 0 ? '' : costs.electricityCostKwh} onChange={handleChange} icon="electric_meter" unit={country.symbol} placeholder="0" />
                <Input label="Costo Arandelas" id="washerCost" name="washerCost" type="number" value={costs.washerCost === 0 ? '' : costs.washerCost} onChange={handleChange} icon="toll" unit={country.symbol} placeholder="0" />
                ...
                <Input label="Costo por mm purgado" id="purgeMmCost" name="purgeMmCost" type="number" value={costs.purgeMmCost === 0 ? '' : costs.purgeMmCost} onChange={handleChange} icon="paid" unit={country.symbol} placeholder="0"/>
